import { contact, equipos, equiposPorCampus, torneos } from "@/data/leagueData";
    ...
    <section className="page-section">
      <div className="container">
        <div className="section-head">
          ...
          <p className="lead">
            Información general del torneo, sedes disponibles y equipos registrados por campus.
          </p>
        </div>
        ...
        <div className="grid grid-2">
          ...
          {equiposPorCampus.map((grupo) => (
            <div className="card" key={grupo.campus}>
              ...
              <p>{grupo.sede}</p>
              <p className="note">{grupo.horario}</p>
